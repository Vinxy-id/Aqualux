...
export const Hero: React.FC = () => {
  ...
  return (
    <section className="pt-24 pb-12 sm:pt-32 sm:pb-20 lg:pt-36 lg:pb-24 bg-white text-slate-900 relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-10 lg:gap-12 items-center">
          ...
          >
            ...
            >
              <a
                ...
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2.5 px-6 sm:px-7 py-3.5 sm:py-4 rounded-full bg-emerald-600 hover:bg-emerald-700 text-white font-extrabold text-sm sm:text-base shadow-md shadow-emerald-600/30 transition-all btn-hover-effect min-h-[48px]"
              >
              ...
              <a
                href="#program"
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3.5 sm:py-4 rounded-full bg-slate-900 hover:bg-slate-800 text-white font-bold text-sm sm:text-base shadow-sm transition-all btn-hover-effect min-h-[48px]"
              >
          ...
          >
            <div className="bg-white rounded-3xl p-4 sm:p-5 border border-slate-300 shadow-xl relative">
              ...
              {/* Main Image Frame */}
              <div className="relative h-64 sm:h-80 rounded-2xl overflow-hidden mb-3.5 border border-slate-200">
                <img
                ...
                <div className="absolute top-3 left-3 bg-white p-1.5 sm:p-2 rounded-xl border border-slate-300 shadow-md">
                  <img src="/aqualux-logo.png" alt="AQUALUX Logo" className="h-7 sm:h-9 w-auto object-contain" />
                </div>

                <div className="absolute bottom-3 left-3 right-3 bg-white p-3 sm:p-3.5 rounded-xl border border-slate-300 text-xs shadow-md">
                  <div className="flex items-center justify-between text-slate-900 font-extrabold mb-1">
                    ...
                    <span className="bg-blue-100 text-blue-900 border border-blue-300 text-[10px] px-2 py-0.5 rounded-full font-extrabold">Pelatih Bersertifikat</span>
                  </div>
              ...
              <div className="grid grid-cols-2 gap-2 sm:gap-2.5 text-xs text-left">
                <div className="bg-slate-100 p-2.5 sm:p-3 rounded-xl border border-slate-300">
                  <span className="text-slate-700 text-[11px] sm:text-xs font-semibold block">Pilihan Kelas:</span>
                  <span className="font-extrabold text-slate-950 block mt-0.5 text-xs sm:text-sm">Privat & Reguler</span>
                </div>

                <div className="bg-slate-100 p-2.5 sm:p-3 rounded-xl border border-slate-300">
                  <span className="text-slate-700 text-[11px] sm:text-xs font-semibold block">Durasi 1 Sesi:</span>
                  <span className="font-extrabold text-blue-700 block mt-0.5 text-xs sm:text-sm">1 Jam 15 Menit</span>
                </div>
              </div>
