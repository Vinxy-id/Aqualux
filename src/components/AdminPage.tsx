        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            <div className="bg-white p-1 rounded-lg shrink-0">
              <img src="./aqualux-logo.png" alt="Aqualux Logo" className="h-6 w-auto object-contain" width="80" height="24" />
            </div>
            <div>
      ...
      <div className="space-y-3">
        <div className="flex items-center gap-2.5">
          <div className="bg-white p-1.5 rounded-xl shadow-xs shrink-0">
            <img src="./aqualux-logo.png" alt="Aqualux Logo" className="h-7 w-auto object-contain" width="90" height="28" />
          </div>
          <div>
